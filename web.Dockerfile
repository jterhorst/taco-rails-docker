...
RUN apt-get update -qq && curl -sL https://deb.nodesource.com/setup_8.x | bash - && apt-get install -y build-essential nodejs postgresql postgresql-contrib libstdc++6 libpq-dev g++ qt5-default libqt5webkit5-dev gstreamer1.0-plugins-base gstreamer1.0-tools gstreamer1.0-x dirmngr gnupg software-properties-common libcurl4-openssl-dev libgtk2.0-0 libnotify-dev libgconf-2-4 xvfb libnss3 libnss3-tools libxss1 libasound2
